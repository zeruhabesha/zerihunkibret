      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-xl border border-slate-200 dark:border-gray-700">
              <h3 className="text-xl font-semibold mb-4 text-blue-600 dark:text-blue-400">My Background</h3>
            ...
            <div className="space-y-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-slate-200 dark:border-gray-700 hover:shadow-xl transition-shadow">
                <h3 className="text-xl font-semibold mb-3 text-purple-600 dark:text-purple-400">Development Skills</h3>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-slate-200 dark:border-gray-700 hover:shadow-xl transition-shadow">
                <h3 className="text-xl font-semibold mb-3 text-green-600 dark:text-green-400">Design Expertise</h3>
                <p className="text-slate-700 dark:text-gray-300">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-slate-200 dark:border-gray-700 hover:shadow-xl transition-shadow">
                <h3 className="text-xl font-semibold mb-3 text-yellow-600 dark:text-yellow-400">Problem Solving</h3>
                <p className="text-slate-700 dark:text-gray-300">
